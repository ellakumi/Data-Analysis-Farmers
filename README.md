...
This is an anlysis on data collected on 4800 farmers 
...
```
#### Household size no longer has null values
```python
...
#### Marital status no longer has null values
```python
...
```python
# Farmers  consent for data collection 
...
#### Graph of secondary source of income and Keeping livestock
```python
plt.figure(figsize = (10,4))
